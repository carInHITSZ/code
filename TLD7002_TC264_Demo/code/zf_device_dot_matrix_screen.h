...
#define DOT_MATRIX_SCREEN_SR0_PIN       (P11_3)
#define DOT_MATRIX_SCREEN_SR1_PIN       (P11_2)
#define DOT_MATRIX_SCREEN_SR2_PIN       (P02_5)
#define DOT_MATRIX_SCREEN_SR3_PIN       (P02_4)                 // 摩托组可以将引脚定义修改为P33_8
