...
extern uint8 Zebra_start_flag;

extern uint8 last_state;
extern float circle_add;
extern float k_add;
...
typedef struct
{
        ...
        RoadType_e last_Road_type;  //元素类型
...
//    int16 Bend_Road;                            /*0 :无               1 :右弯道     2 :左弯道*/
        ...
        int16 image_element_barriars; /*0 :无障碍         1 :左障碍       2 :右障碍*/
        int16 image_element_barriars_flag; /*障碍进程*/
...
extern DIRECTION DIR_1[400];
extern DIRECTION DIR_1_Y[400];
extern uint32 dir_stop;
extern float new_offset, offset, last_offset;
extern uint16 last_mid_point;
extern uint8 ramp_flag;
extern float Pitch_Ramp;
extern float Pitch_Ramp_1;
extern float Pitch_Ramp_2;
extern float Pitch_Ramp_3;
extern float circle_add_1;
extern float exposure;
extern float Zebra_break_first;
extern float Repair_X_L;
extern float Repair_X_R;
extern float mid_std;
extern float circle_L_1;
extern float circle_L_2;
extern float circle_L_3;
extern float circle_L_4;
extern float circle_R_1;
extern float circle_R_2;
extern float circle_R_3;
extern float circle_R_4;
extern float special_ring, new_sepcial_ring;
extern float special_cross;
extern float k_rlen_l,k_rlen_r;
extern int Real_state[5][2];
