...
{
    int         ret                  = MSP_SUCCESS;
    const char* login_params         = "appid = 594a7b46, work_dir = ."; // 登录参数, appid 与 msc 库绑定, 请勿随意改动
    ...
    // 初始化全局变量 sub
    sub = n.subscribe("/voiceWords", 1000, voiceWordsCallback);
